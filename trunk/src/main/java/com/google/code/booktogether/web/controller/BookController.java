...
public class BookController {
	...
	public ModelAndView handleInsertBook(HttpServletRequest req) {
		...
		String name = ServletRequestUtils.getStringParameter(req, "name",
				"no_title");
		String publish_date = ServletRequestUtils.getStringParameter(req,
				"publish_date", "mm");
		String publish_comp = ServletRequestUtils.getStringParameter(req,
				"publish_comp", "해철");
		int price = ServletRequestUtils.getIntParameter(req, "price", 0);
		String corver = ServletRequestUtils.getStringParameter(req, "corver",
				"");
		String isbn10 = ServletRequestUtils.getStringParameter(req, "isbn10",
				"1234567890");
		String isbn13 = ServletRequestUtils.getStringParameter(req, "isbn13",
				"1234567890123");
		String category = ServletRequestUtils.getStringParameter(req,
				"category", "국내");
		String description = ServletRequestUtils.getStringParameter(req,
				"description", "설명");
		String[] author_name = ServletRequestUtils.getStringParameters(req,
				"author_name");
		String[] author_div = ServletRequestUtils.getStringParameters(req,
				"author_div");
		...
		book.setPublishComp(publish_comp);
		book.setPrice(price);
		book.setBookCover(corver);
	...
	public ModelAndView handleGetBook(HttpServletRequest req) {
		...
		if (book == null) {
			...
			// return new
			// ModelAndView("redirect:/book/getBook.do?id="+book.getId());
			return null;
	...
	public ModelAndView handleSearchBook(HttpServletRequest req) {
		...
		String query = ServletRequestUtils.getStringParameter(req, "query",
				"스프링");
		String searchType = ServletRequestUtils.getStringParameter(req,
				"searchType", "all");
	...
	public ModelAndView handleCheckBook(HttpServletRequest req) {
		...
		return new ModelAndView("redirect:/book/getBook.do?id="
				+ book.getIdNum());
